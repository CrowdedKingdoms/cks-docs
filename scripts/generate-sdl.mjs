...
function deriveManagementSdl(gameSdl, surface) {
  ...
  // The header ships: this file is served at /schema/management-api.graphql. It
  // named the source repository until 2026-08-23, which put a private repository
  // name in a published artifact for no reader's benefit -- a generator's own
  // provenance comment is the easiest place for one to hide, because nobody
  // reviews the boilerplate a generator emits. Describe the source, do not name it.
  const header =
    `# DERIVED FILE - do not edit.\n` +
    `# Generated by scripts/generate-sdl.mjs from the unified game API schema,\n` +
    `# filtered to the management surface in scripts/management-surface.json.\n` +
    `# The management API was retired 2026-08-06; this SDL has no repository of its own.\n\n`;
