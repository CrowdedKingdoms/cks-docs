...
See [Client Workflow](/overview/client-workflow), [Portals & app-scoped tokens](/management-api/portals-and-app-tokens), and [CrowdyJS → Two-endpoint architecture](/crowdyjs/readme).
...
1. **`platformConfig.sharedGameApiUrl`** returns `https://game.shared.dev.cks-env.com` on [management GraphQL](https://api.dev.crowdedkingdoms.com/graphql).
...
- **Management:** [https://api.dev.crowdedkingdoms.com/graphql](https://api.dev.crowdedkingdoms.com/graphql)
- **Game (shared):** [https://game.shared.dev.cks-env.com/graphql](https://game.shared.dev.cks-env.com/graphql)
