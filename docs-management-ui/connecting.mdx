...
| Surface | URL |
| ------- | --- |
| Management UI | [https://studio.dev.crowdedkingdoms.com](https://studio.dev.crowdedkingdoms.com) |
...
On production (and any other environment you were given), read `platformConfig.sharedGameApiUrl` or your app's `gameApiUrl` for the correct host — do not assume the sandbox URL.
...
- **[Management API](/management-api/intro)** — programmatic identity, apps, and billing.
