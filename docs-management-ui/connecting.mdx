...
| Management API | [https://ck.dev.v7.cks-env.com](https://ck.dev.v7.cks-env.com) |
| Shared Game API (HTTP) | `https://ck.dev.v7.cks-env.com/graphql` |
| Shared Game API (WebSocket) | `wss://ck.dev.v7.cks-env.com/graphql` |
