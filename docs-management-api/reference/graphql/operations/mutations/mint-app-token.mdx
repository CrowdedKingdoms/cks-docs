...
#### [<code style={{ fontWeight: 'normal' }}>mintAppToken.<b>input</b></code>](#input)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>MintAppTokenInput!</b></code>](/reference/graphql/types/inputs/mint-app-token-input.mdx) <Badge class="badge badge--secondary badge--non_null" text="non-null"/> <Badge class="badge badge--secondary " text="input"/> \{#input\}
