...
Download the `v2.17.0` release of the plugin from the public repository, `CrowdedKingdoms/CrowdySDK-Unreal` on GitHub.

:::note[The release you install must match the version this guide describes (2.17).]
:::
