...
#### [<code style={{ fontWeight: 'normal' }}>UdpNotification.<b>ClientVideoNotification</b></code>](/reference/graphql/types/objects/client-video-notification.mdx) <Badge class="badge badge--secondary " text="object"/> 
...
#### [<code style={{ fontWeight: 'normal' }}>UdpNotification.<b>ActorLeftNotification</b></code>](/reference/graphql/types/objects/actor-left-notification.mdx) <Badge class="badge badge--secondary " text="object"/> 
