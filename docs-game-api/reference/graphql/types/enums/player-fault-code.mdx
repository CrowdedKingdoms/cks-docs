...
#### [<code style={{ fontWeight: 'normal' }}>PlayerFaultCode.<b>CIRCUIT&#x005F;OPEN</b></code>](#circuit-open) \{#circuit-open\} 
...
#### [<code style={{ fontWeight: 'normal' }}>PlayerFaultCode.<b>ENGINE&#x005F;SWITCHED&#x005F;OFF</b></code>](#engine-switched-off) \{#engine-switched-off\} 
