---
id: player-code-project-import-file
title: playerCodeProjectImportFile
---
...
#### [<code style={{ fontWeight: 'normal' }}>playerCodeProjectImportFile.<b>input</b></code>](#input)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>ImportPlayerCodeProjectFileInput!</b></code>](/reference/graphql/types/inputs/import-player-code-project-file-input.mdx) <Badge class="badge badge--secondary badge--non_null" text="non-null"/> <Badge class="badge badge--secondary " text="input"/> \{#input\} 
