---
id: player-code-project-save-files
title: playerCodeProjectSaveFiles
---
...
#### [<code style={{ fontWeight: 'normal' }}>playerCodeProjectSaveFiles.<b>input</b></code>](#input)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>SavePlayerCodeProjectFilesInput!</b></code>](/reference/graphql/types/inputs/save-player-code-project-files-input.mdx) <Badge class="badge badge--secondary badge--non_null" text="non-null"/> <Badge class="badge badge--secondary " text="input"/> \{#input\} 
