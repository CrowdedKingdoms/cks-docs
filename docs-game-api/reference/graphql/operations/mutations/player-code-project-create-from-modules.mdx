---
id: player-code-project-create-from-modules
title: playerCodeProjectCreateFromModules
---
...
#### [<code style={{ fontWeight: 'normal' }}>playerCodeProjectCreateFromModules.<b>input</b></code>](#input)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>CreatePlayerCodeProjectFromModulesInput!</b></code>](/reference/graphql/types/inputs/create-player-code-project-from-modules-input.mdx) <Badge class="badge badge--secondary badge--non_null" text="non-null"/> <Badge class="badge badge--secondary " text="input"/> \{#input\} 
